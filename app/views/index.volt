...
<html lang="en">
	<head>
		...
		{{- stylesheet_link("forum/css/theme.css", true) -}}
		{{- stylesheet_link("forum/css/editor.css", true) -}}
		{{- stylesheet_link("forum/css/diff.css", true) -}}
		{{- stylesheet_link("forum/css/style.css", true) -}}
	</head>
	<body>
		{{ content() }}
		...
		{{ javascript_include("forum/js/editor.js") }}
		{{ javascript_include("forum/js/forum.js") }}
		{{ javascript_include("forum/js/gs.js") }}
